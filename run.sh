...
nohup python evader.py --name "crowd-test-" \
  --data_dir "/evader/data/" \
  --log_dir "/evader/log/" \
  --checkpoint_dir "/evader/check_point/" \
  --no_addresses_agent_challenge_table 10 \
...
#sleep 10
#
#nohup python evader.py --name "fcnet_hiddens_scale_by2-" \
#  --data_dir "/evader/data/" \
#  --log_dir "/evader/log/" \
